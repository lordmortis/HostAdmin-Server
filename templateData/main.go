...
// sources:
// ios-email-profile-error.html (149B)
// ios-email-profile.xml (3.684kB)
...
var _bintree = &bintree{nil, map[string]*bintree{
	"ios-email-profile-error.html": {iosEmailProfileErrorHtml, map[string]*bintree{}},
	"ios-email-profile.xml":        {iosEmailProfileXml, map[string]*bintree{}},
}}
